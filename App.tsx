                ...
                <form onSubmit={(e) => {
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <select value={gender} onChange={e => setGender(e.target.value as Gender)} className="bg-slate-50 p-4 rounded-2xl w-full font-bold outline-none">
              ...
              <div className="space-y-4 relative">
                   ...
                   {showSuggestions && suggestions.length > 0 && (
                     <div className="absolute z-50 left-0 right-0 top-[72px] bg-white border border-slate-100 shadow-2xl rounded-2xl overflow-hidden fade-in">
                       {suggestions.map((s, idx) => (
                         <div key={idx} onClick={() => { setSearchQuery(s); handleSearch(s); }} className="w-full text-left p-4 text-sm font-bold text-slate-600 suggestion-item border-b border-slate-50 last:border-0">
                           {s}
                         </div>
                       ))}
                     </div>
                ...
                <div className="grid grid-cols-12 gap-2">
                  <div className="col-span-4 space-y-1 text-left">
                    <label className="text-[11px] font-black text-slate-700 uppercase ml-2">Qtd.</label>
                  ...
                  <div className="col-span-4 space-y-1 text-left">
                    <label className="text-[11px] font-black text-slate-700 uppercase ml-2">Unid.</label>
